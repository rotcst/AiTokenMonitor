...
For an updater-compatible Release, keep the tag and project version aligned (for example `v1.9.8`)
and upload `AiTokenMonitor-1.9.8.exe`. The client verifies the SHA-256 digest generated by GitHub.
