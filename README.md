...
For an updater-compatible Release, keep the tag and project version aligned (for example `v1.9.7`)
and upload `AiTokenMonitor-1.9.7.exe`. The client verifies the SHA-256 digest generated by GitHub.
