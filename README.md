...
For an updater-compatible Release, keep the tag and project version aligned (for example `v1.9.6`)
and upload `AiTokenMonitor-1.9.6.exe`. The client verifies the SHA-256 digest generated by GitHub.
